...
class SmartWikiFillController {
	...
	private function createList($listPackage, $titleArray, $orderArray) {
		// Current name
		$listName = $listPackage instanceof SmartWikiPackage ? $listPackage->getTitle() : ($listPackage == null ? wfMsgForContent('smartwiki-fill-without-package') : $listPackage);
		...
		return 
			Xml::tags( 'tr', null, 
				Xml::tags(
					...
					($listPackage instanceof SmartWikiPackage ? 
						Xml::tags(
							'span',
							array(
